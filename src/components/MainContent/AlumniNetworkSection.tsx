...
export const AlumniNetworkSection = () => {
  ...
  const alumniData: AlumniMember[] = [
    ...
    /*{
      id: 'a9',
      name: 'Gauri Joshi',
      avatar: '/assets/GauriJoshi.jpeg',
      isActive: true,
      position: 'Software Engineer',
      company: 'Apple',
      department: 'ENTC Engineering (2017)',
      graduationYear: 2017,
      location: 'Jersey City, New Jersey, United States ',
      email: '',
      linkedin: 'https://www.linkedin.com/in/gauripjoshi/',
      bio: '',
      achievements: ['Meta Intern', 'Amazon SDE', 'Google Summer of Code', 'AWS Certified Solutions Architect - Associate'],
      skills: ['Python', 'C++', 'Web Development', 'Flutter', 'C (Programming Language)'],
      industry: 'Technology'
    ...
    {
      id: 'a10',
      name: 'Aniruddha Satoskar',
      avatar: '/assets/Aniruddha.jpeg',
      isActive: true,
      position: 'SOC Architect',
      company: 'Apple (USA)',
      department: 'ENTC Engineering (2009)',
      graduationYear: 2009,
      location: 'Austin, Texas, United States',
      email: '',
      linkedin: 'https://www.linkedin.com/in/aniruddha-satoskar/',
      bio: 'Experienced SOC Architect at Apple, specializing in designing and implementing secure system-on-chip architectures. Previously worked at Cirrus Logic, contributing to audio and voice processing technologies. Passionate about hardware security and system design.',
      achievements: ['DSP Speech Separation', 'LTE Firmware Development', 'ASIC Design Leadership', 'Mixed-Signal IC Design', 'Apple Silicon Architecture'],
      skills: ['Processors', 'VLSI', 'Simulation', 'Digital Signal Processing', 'Embedded Systems', 'Machine Learning', 'C++'],
      industry: 'Technology'
    },
    {
      id: 'a11',
