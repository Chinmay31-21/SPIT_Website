...
const procurementNotices = [
  ...
  },
  {
    ...
    title: 'ANNEXURE-III-Electronics-Equipments',
    type: 'tender',
    status: 'Open',
    issueDate: '2023-10-16',
    closingDate: '2025-10-20',
  ...
  },
  {
    ...
    title: 'ANNEXURE-III-DESKTOPS-LAPTOPS-SOFTWARES',
    type: 'tender',
    status: 'Open',
    issueDate: '2023-10-16',
    closingDate: '2025-10-20',
...
export const NoticeTenderOctober2023 = () => {
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">
            Notice Inviting Tender-2 _ OCTOBER_2023
          </h1>
...
export default NoticeTenderOctober2023;